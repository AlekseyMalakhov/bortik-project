...
const chat = () => {
    !(function (t) {
            ...
            t.exports = function (t, e) {
                ...
                if ((n = h ? o : y ? o[v] || c(v, {}) : (o[v] || {}).prototype))
                    for (s in e) {
                        if (
                            ((l = e[s]),
                            (d = t.noTargetGet ? (p = r(n, s)) && p.value : n[s]),
                            !f(h ? s : v + (y ? "." : "#") + s, t.forced) && void 0 !== d)
                        ) {
        ...
        function (t, e, n) {
            ...
            (t.exports = function (t, e, n, c) {
                ...
                "function" == typeof n &&
                    ...
                    (a = s(n)).source || (a.source = d.join("string" == typeof e ? e : ""))),
                    t !== o ? (f ? !p && t[e] && (l = !0) : delete t[e], l ? (t[e] = n) : r(t, e, n)) : l ? (t[e] = n) : u(e, n);
        ...
        function (t, e, n) {
            ...
            f
                ? (r = (o = f.split("."))[0] + o[1])
                : u && (!(o = u.match(/Edge\/(\d+)/)) || o[1] >= 74) && (o = u.match(/Chrome\/(\d+)/)) && (r = o[1]),
                (t.exports = r && +r);
        },
        function (t, e, n) {
            var o = n(46);
        ...
        function (t, e, n) {
            ...
            })("versions", []).push({ version: "3.8.3", mode: o ? "pure" : "global", copyright: "\xa9 2021 Denis Pushkarev (zloirock.ru)" });
        },
        function (t, e) {
            var n = 0,
                o = Math.random();
        ...
        function (t, e, n) {
            ...
            !(function () {
                              ...
                              "complete" === document.readyState || (!document.attachEvent && "interactive" === document.readyState)
                                  ...
                                  : n ||
                                    (document.addEventListener
                                        ? (document.addEventListener("DOMContentLoaded", o, !1), window.addEventListener("load", o, !1))
                                        : (document.attachEvent("onreadystatechange", r), window.attachEvent("onload", o)),
                                    (n = !0)),
                              !0);
                    };
                })();
                function r(t) {
                    ...
                    })(t, "".concat(e, "/").concat("1_82_0", "/static/js/widget.").concat(n.h, ".js"));
                }
                var i = n(218).default;
                        ...
                        return setTimeout(function () {
                            ...
                            !(function (t, e, n) {
                                ...
                                t &&
                                    ...
                                    ((o.contentWindow.__REDUX_DEVTOOLS_EXTENSION__ = window.__REDUX_DEVTOOLS_EXTENSION__),
                                    (o.contentWindow.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ = window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__)),
                                    (function (t) {
                                        var o = "//localhost:3000/static/js/WidgetIframe.js";
                                        o = "".concat(e).concat("1_82_0", "/static/js/chunk-WidgetIframe-").concat(n.h, ".js");
                                    ...
                                    (o.contentWindow.tidioChatApi = window.tidioChatApi),
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    ...
                                    try {
                                        ...
                                        if (
                                            (n.initEvent("".concat(this.eventPrefix).concat(t), !0, !0),
                                            (n.data = e),
